 ...
 */
package fr.univ.rennes1.cri.opiR1.web.controllers;
...
import fr.univ.rennes1.cri.opiR1.domain.beans.user.Individu;
import fr.univ.rennes1.cri.opiR1.web.beans.parameters.RegimeInscription;
import fr.univ.rennes1.cri.opiR1.web.utils.NavigationRulesConst;
import fr.univ.rennes1.cri.opiR1.web.utils.Utilitaires;
...
public class WelcomeController extends AbstractContextAwareController {
	...
	private String lienCalendrierDeCandidature;
        ...
        /**
         * The URL of the depot des dossiers electroniques
         */
        /*private String lienDepotDossiers;
        */
	public String lienDepotDossiers;

        /**
         * The URL of the consultation des dossiers electroniques
         */
        private String lienConsultationDossiers;
	...
	/**
	 * @see fr.univ.rennes1.cri.opiR1.web.controllers.AbstractDomainAwareBean#reset()
	 */
	@Override
	public void reset() {
		super.reset();
	...
	/** 
	 * @see fr.univ.rennes1.cri.opiR1.web.controllers.AbstractContextAwareController#afterPropertiesSetInternal()
	 */
	@Override
...
//					htmlBody, null, ind, smtpService, null);
	...
	public void setLienCalendrierDeCandidature(final String lienCalendrierDeCandidature) {
        ...
        /**
         *
         * @return The URL of the depot des dossiers electroniques.
         */
        public String getLienDepotDossiers() {
                return lienDepotDossiers;
        }

        /**
         *
         * @param lienDepotDossiers.
         */
        public void setLienDepotDossiers(final String lienDepotDossiers) {
                this.lienDepotDossiers = lienDepotDossiers;
        }

        /**
         *
         * @return The URL of the consultation des dossiers electroniques.
         */
        public String getLienConsultationDossiers() {
                return lienConsultationDossiers;
        }

        /**
         *
         * @param lienConsultationDossiers.
         */
        public void setLienConsultationDossiers(final String lienConsultationDossiers) {
                this.lienConsultationDossiers = lienConsultationDossiers;
        }
