		...
		<t:div styleClass="welcomeBackSalamander">
			<e:panelGrid columns="3" columnClasses="blockColLeft, blockColCenter, blockColRight" styleClass="welcomeConnexion">
                                ...
                                <t:div styleClass="welcomeInfoFirstConnexion">
                                        <e:subSection value="#{msgs['FORMATIONS.WELCOME.TITLE']}" styleClass="section-header-red"  style="text-align:center;"/>

                                        <t:div>
                                                <e:text value="#{msgs['FORMATIONS.WELCOME.RESUME_ONE']}" />
                                        </t:div>
                                        <t:div>
                                                <e:text value="#{msgs['FORMATIONS.WELCOME.RESUME_TWO']}" />
                                        </t:div>
				...
				<t:graphicImage url="/media/images/go-next-red.png" />
                                ...
                                <t:div styleClass="welcomeGotoFirstConnexion">
                                        <e:subSection value="#{msgs['FORMATIONS.WELCOME.SUBTITLE']}" />
                                        <t:div style="text-align:right;">
                                                <e:form id="seeFormation">
                                                        <e:commandButton
                                                                action="#{welcomeController.goSeeFormation}"
                                                                value="#{msgs['NAVIGATION.TEXT.SEE_FORMATION']}" />
                                                </e:form>
                                        </t:div>
                                </t:div>
				...
				<t:div styleClass="welcomeInfoFirstConnexion">
					<e:subSection value="#{msgs['WELCOME.SUB_TITLE.ONE_CANDI']}"  styleClass="section-header-red" style="text-align:center;"/>
					...
					<e:form id="loginCandidatForm">
						...
						<t:div style="text-align:right;">
							<e:commandButton value="#{msgs['WELCOME.FORGET_NUM_DOS']}"
                                ...
                                <t:div styleClass="welcomeInfoDepot">
                                        <e:subSection value="#{msgs['DEMAT.WELCOME.TITLE_DEPOT']}"  styleClass="section-header-red" style="text-align:center;"/>
                                        <e:text value="#{msgs['DEMAT.WELCOME.SUBTITLE_DEPOT']}" />

                                        <t:div>
                                                <e:text value="#{msgs['DEMAT.WELCOME.RESUME_ONE']}" />
                                        </t:div>
                                        <t:div>
                                                <e:text value="#{msgs['DEMAT.WELCOME.RESUME_TWO']}" />
                                        </t:div>

                                        <t:div>
                                                <e:text value="#{msgs['DEMAT.WELCOME.RESUME_THREE']}" />
                                        </t:div>
                                </t:div>
                                ...
                                <t:div styleClass="welcomeGotoFirstConnexion">
                                        <e:subSection value="#{msgs['DEMAT.WELCOME.ENVOI_TITLE']}" />
                                        <e:form >
                                        	<t:div style="text-align:right;">
                                        	
                                                        <e:commandButton value="#{msgs['DEMAT.WELCOME.ENVOI_LIEN']}"
                                                         onclick="openPage('#{welcomeController.lienDepotDossiers}','#{msgs['APPLICATION.BIG_TITLE']}','')" />
