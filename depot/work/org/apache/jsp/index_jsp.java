...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/menuAccueil.jsp");
  }
...
Properties prop = com.de_mvc.tools.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
      ...
      out.print( prop.getProperty("bienvenue")  );
      out.write("</span></p>\n");
      out.write("\t\t\t<p><span class=\"section-header-blue\">");
      out.print( prop.getProperty("titre")  );
      out.write("</span></p>\n");
      out.write("\t\t\t<h2><span class=\"section-header-two-black\"></span></h2>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("<ul>\n");
      out.write("<div id =\"validation\" style=\"display: none; \"><li/>le numero de dossier et la date de naissance sont obligatoire</div>\n");
      out.write("</ul>\n");
      out.write("\n");
      out.write("<div class=\"salahddine_welcomeInfoFirstConnexion\">\n");
      out.write("<form action=\"Etape.do\" method=\"post\" name=\"myform\" onsubmit='return Verif();'>\n");
      out.write("\n");
      ...
      out.print( prop.getProperty("titreLogin")  );
      out.write("</span></h2>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      ...
      out.print( prop.getProperty("numDossier")  );
      out.write("<input type=\"password\" id=\"numDossier\" name=\"numDossier\" onblur='verifPseudo(this)'/></span></p>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t<center>\n");
      out.write("\t\t<p><span class=\"portlet-section-text\">");
      out.print( prop.getProperty("dateNaissance")  );
      out.write("<input type=\"text\" id=\"dateNaissance\" name=\"dateNaissance\" value=\"\" onblur='verifPseudo(this)'/></span></p>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t\n");
      out.write("\t\t<br></br>\n");
      ...
      out.write("\tif (document.getElementById(\"numDossier\").value.length != 0 && document.getElementById(\"dateNaissance\").value.length != 0 ){\n");
