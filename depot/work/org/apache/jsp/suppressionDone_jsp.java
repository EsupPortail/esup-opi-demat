...
public final class suppressionDone_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Properties prop = com.de_mvc.tools.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
      ...
      out.write("\n");
      out.write("<h1>");
      out.print( request.getSession(false).getAttribute("nomUsr") );
      out.write("</h1>\n");
      out.write("<center><p><span class=\"section-header-blue\">");
      out.print( request.getAttribute("nomFichier") );
      out.write(' ');
      out.write(' ');
      out.print( prop.getProperty("messageEstSupprime") );
