...
public final class recommandation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Properties prop = com.de_mvc.tools.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
 ...
 int nbMailRecommandation = Integer.parseInt(request.getAttribute("nbMailRecommandation").toString()); 
      ...
      out.print( prop.getProperty("deposerMails")  );
      out.write("</span></p>\n");
      out.write("\t\t\t<p><span class=\"section-header-blue\">");
 out.print( prop.getProperty("encoreMails") + (3-nbMailRecommandation) + " " + prop.getProperty("adresseMails") ); 
      out.write("</span></p>\n");
      out.write("\t\t\t<h2><span class=\"section-header-two-black\"></span></h2>\n");
      out.write("</div>\n");
      out.write("<div class=\"salahddine_welcomeInfoFirstConnexion2\">\n");
      out.write("<form action=\"envoieLiens\" method=\"post\" name=\"myform\">\n");
      out.write("\n");
      ...
      out.write("\t\t");
      out.print( prop.getProperty("mail1")  );
      out.write("<input type=\"text\" name=\"mail1\" value=\"\" size=\"15\"/>\n");
      out.write("\t\t</span></p>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t");
      ...
      out.write("\n");
      out.write("\t\t<input type=\"hidden\" name=\"nbMailRecommandation\" value=\"");
      out.print( 3-nbMailRecommandation  );
      out.write("\" maxlength=\"8\" size=\"10\" class=\"form-button\"/>\n");
      out.write("\t\t<br><br><br>\n");
      out.write("\t\t<center><input type=\"submit\" name=\"Submit\" value=\"");
      out.print( prop.getProperty("envoie")  );
      out.write("\" maxlength=\"8\" size=\"10\" class=\"form-button\"/>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t</td>\n");
      out.write("\t\t\n");
