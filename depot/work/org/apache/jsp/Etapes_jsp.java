...
public final class Etapes_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Properties prop = com.de_mvc.tools.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
      ...
      out.write("<h1>");
      out.print( request.getSession(false).getAttribute("nomUsr").toString() );
      out.write("</h1>\n");
      out.write("<center><p><span class=\"section-header-blue\">");
      out.print( prop.getProperty("titreEtape")  );
...
for(String etape : codeEtapes){
	...
	i++;
      ...
      out.write("<center><p><span class=\"section-header-blue\"><a href=\"recommandation\" class=\"lien\">");
      out.print( prop.getProperty("lienRecommandation")  );
      out.write("</a></span></p></center>\n");
      out.write("<!--   <center><p><span class=\"section-header-blue\"><a href=\"");
      out.print( prop.getProperty("lienCandidature") );
      out.write(" \" class=\"lien\">");
      out.print( prop.getProperty("retourCandidature")  );
      out.write("</a></span></p></center> -->\n");
      out.write("</div>\n");
      out.write(" </div>\n");
      out.write(" ");
