...
public final class nomPrenomRef_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Properties prop = com.lr_mvc.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t<form action=\"validationNomPrenom\" method=\"post\" name=\"myform\">\n");
      out.write("\t<tr>\n");
      out.write("\t\t<td>\n");
      out.write("\t\t\n");
      out.write("\t\t<p><span class=\"section-header-blue\">");
      out.print( prop.getProperty("demandeNomPrenom") );
      out.write("</span></p><br>\n");
      out.write("\t\t\n");
      out.write("\t\t<p><span class=\"portlet-section-text\"><label for=\"nomRef\">");
      out.print( prop.getProperty("nom")  );
      out.write("</label><input type=\"text\" name=\"nomRef\" /></span></p>\n");
      out.write("\t\t\n");
      out.write("\t\t<p><span class=\"portlet-section-text\"><label for=\"prenomRef\">");
      out.print( prop.getProperty("prenom") );
      out.write("</label><input type=\"text\" name=\"prenomRef\" /></span></p>\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t<p><span class=\"portlet-section-text\"><label for=\"titreRef\"> titre : </label><input type=\"text\" name=\"titreRef\" /></span></p>\n");
      out.write("\t\t\n");
      out.write("\t\t<p><span class=\"portlet-section-text\"><label for=\"fonctionRef\"> organisme : </label><input type=\"text\" name=\"fonctionRef\" /></span></p>\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t<br>\n");
      out.write("\t\t<center>\n");
      ...
      out.write("\n");
      out.write("<br></br>\n");
      out.write("<!-- <center><p><span class=\"section-header-blue\"><a href=\"deconnection\">");
