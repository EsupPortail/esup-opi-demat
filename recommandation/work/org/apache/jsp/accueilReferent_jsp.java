...
public final class accueilReferent_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Properties prop = com.lr_mvc.LoadProperties.load(getServletContext().getRealPath("/")+"/WEB-INF/classes/Message_fr.properties");
      ...
      out.write("</span></p>\n");
      out.write("\t\t\t<p><span class=\"section-header-blue\">");
      out.print( prop.getProperty("titreRecommandation") );
      out.write("</span></p>\n");
      out.write("\t\t\t<h2><span class=\"section-header-two-black\"></span></h2>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("<ul>\n");
      out.write("<div id =\"validation\" style=\"display: none; \"><li/>le mail et le mot de passe sont obligatoire</div>\n");
      out.write("</ul>\n");
      out.write("\n");
      out.write("<div class=\"salahddine_welcomeInfoFirstConnexion\">\n");
      out.write("<form action=\"loginReferent\" method=\"post\" name=\"myform\" onsubmit='return Verif();'>\n");
      ...
      out.write("<input type=\"password\" id=\"password\" name=\"password\" value=\"\" onblur='verifPseudo(this)'/></span></p>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t\n");
      out.write("\t\t<br>\n");
      out.write("\t\t<center>\n");
      ...
      out.write("\" maxlength=\"8\" size=\"10\" class=\"form-button\"/><br>\n");
      out.write("\t\t\t<a href='MDPOublie.jsp' >");
      out.print( prop.getProperty("MDPOublie")  );
      out.write("</a>\n");
      out.write("\t\t</center>\n");
      out.write("\t\t</td>\n");
      out.write("\t\t\n");
      ...
      out.write("\tif (document.getElementById(\"adresseMail\").value.length != 0 && document.getElementById(\"password\").value.length != 0 ){\n");
