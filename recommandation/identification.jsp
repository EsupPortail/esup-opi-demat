...
<ul>
<div id ="validation" style="display: none; "><li/>le mail est obligatoire</div>
</ul>


<div class="salahddine_welcomeInfoFirstConnexion">
<form action="choixMDP" method="post" name="myform" onsubmit='return Verif();'>
<table class="welcomeConnexion">
	<tr>
		<td>
		<center>
		<h2><span style="text-align: center;" class="section-subheader"><%= prop.getProperty("demandeSaisiMail") %></span></h2>
		</center>
